...
export default class OrgDetails extends Component {
    ...
    render() {
        return <div className='h_f_container'>
                ...
                <form className='form_container' onSubmit={this.submit}>
                    ...
                    <div id='scroll_container'>
                        ...
                        <div className='tag_button_container'>
                            {Object.keys(allTags.get('allTags')).map(tagId =>
                                <button
                                    key={tagId}
                                ...
                                >{allTags.get('allTags')[tagId]}</button>
                            )}
                        </div>
                        <div className='description_container'>
                            <div className='description_element'>
            ...
            <Link className="btn btn-primary btn-sm back" to="/Search">
            Back
          </Link>
        </div>;
    }
